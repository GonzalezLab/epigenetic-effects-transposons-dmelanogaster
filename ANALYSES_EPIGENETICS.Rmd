...
Test position
```{r}
zscoreTMM_H3K9me3_enrich <- unique(zscoreTMM[zscoreTMM$histone=="H3K9me3" & zscoreTMM$avg>0 & zscoreTMM$pvalueF=="Significant",c("TE", "gene", "position2", "zscoreF")])

chisq.test(zscoreTMM_H3K9me3_enrich$position2, zscoreTMM_H3K9me3_enrich$zscoreF, correct=T)
table(zscoreTMM_H3K9me3_enrich$position2, zscoreTMM_H3K9me3_enrich$zscoreF)

chisq.posthoc.test(as.matrix(table(zscoreTMM_H3K9me3_enrich$position2, zscoreTMM_H3K9me3_enrich$zscoreF)), simulate.p.value = TRUE, method = "bonferroni")

zscoreTMM_H3K9me3_deplete <- unique(zscoreTMM[zscoreTMM$histone=="H3K9me3" & zscoreTMM$avg<0 & zscoreTMM$pvalueF=="Significant",c("TE", "gene", "position2", "zscoreF")])

chisq.test(zscoreTMM_H3K9me3_deplete$position2, zscoreTMM_H3K9me3_deplete$zscoreF, correct=T)
table(zscoreTMM_H3K9me3_deplete$position2, zscoreTMM_H3K9me3_deplete$zscoreF)

chisq.posthoc.test(as.matrix(table(zscoreTMM_H3K9me3_deplete$position2, zscoreTMM_H3K9me3_deplete$zscoreF)), simulate.p.value = TRUE, method = "bonferroni")

zscoreTMM_H3K27ac_enrich <- unique(zscoreTMM[zscoreTMM$histone=="H3K27ac" & zscoreTMM$avg>0 & zscoreTMM$pvalueF=="Significant",c("TE", "gene", "position2", "zscoreF")])

chisq.test(zscoreTMM_H3K27ac_enrich$position2, zscoreTMM_H3K27ac_enrich$zscoreF, correct=T)
table(zscoreTMM_H3K27ac_enrich$position2, zscoreTMM_H3K27ac_enrich$zscoreF)

chisq.posthoc.test(as.matrix(table(zscoreTMM_H3K27ac_enrich$position2, zscoreTMM_H3K27ac_enrich$zscoreF)), simulate.p.value = TRUE, method = "bonferroni")

zscoreTMM_H3K27ac_deplete <- unique(zscoreTMM[zscoreTMM$histone=="H3K27ac" & zscoreTMM$avg<0 & zscoreTMM$pvalueF=="Significant",c("TE", "gene", "position2", "zscoreF")])

chisq.test(zscoreTMM_H3K27ac_deplete$position2, zscoreTMM_H3K27ac_deplete$zscoreF, correct=T)
table(zscoreTMM_H3K27ac_deplete$position2, zscoreTMM_H3K27ac_deplete$zscoreF)

chisq.posthoc.test(as.matrix(table(zscoreTMM_H3K27ac_deplete$position2, zscoreTMM_H3K27ac_deplete$zscoreF)), simulate.p.value = TRUE, method = "bonferroni")

zscoreTMM_Bivalent_enrich <- unique(zscoreTMM[zscoreTMM$histone=="Bivalent" & zscoreTMM$avg>0 & zscoreTMM$pvalueF=="Significant",c("TE", "gene", "position2", "zscoreF")])

chisq.test(zscoreTMM_Bivalent_enrich$position2, zscoreTMM_Bivalent_enrich$zscoreF, correct=T)
table(zscoreTMM_Bivalent_enrich$position2, zscoreTMM_Bivalent_enrich$zscoreF)

chisq.posthoc.test(as.matrix(table(zscoreTMM_Bivalent_enrich$position2, zscoreTMM_Bivalent_enrich$zscoreF)), simulate.p.value = TRUE, method = "bonferroni")

zscoreTMM_Bivalent_deplete <- unique(zscoreTMM[zscoreTMM$histone=="Bivalent" & zscoreTMM$avg<0 & zscoreTMM$pvalueF=="Significant",c("TE", "gene", "position2", "zscoreF")])

chisq.test(zscoreTMM_Bivalent_deplete$position2, zscoreTMM_Bivalent_deplete$zscoreF, correct=T)
table(zscoreTMM_Bivalent_deplete$position2, zscoreTMM_Bivalent_deplete$zscoreF)

chisq.posthoc.test(as.matrix(table(zscoreTMM_Bivalent_deplete$position2, zscoreTMM_Bivalent_deplete$zscoreF)), simulate.p.value = TRUE, method = "bonferroni")
