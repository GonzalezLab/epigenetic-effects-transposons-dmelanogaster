...
# change:
# will do this for all possible regions detected above, not for each TE
# then we'll have more null regions (altough each gene will be used ONCE as intron/CDS, etc.)
# I comment was was done before
...
# I keep the original version, altough it can be found in the original folder null_distribution
# histones="H3K9me3 H3K27ac bivalent"
# tissues="head gut ovary"
# assemblies="AKA-017 JUT-011 MUN-016 SLA-001 TOM-007"
# effects="increment depletion"
